...
<head>
    ...
    <style>
        ...
        .message.user .bubble { background-color: #fff; color: #413d3c; margin-left: auto; border-radius: 12px 12px 0 12px; border: 1px solid #ddd; }
        ...
        .avatar.user { background-color: #a0a0a0; }
            ...
            <c:forEach var="msg" items="${historialChat}">
                ...
                <div class="message ${isUserMessage ? 'user' : 'bot'}">
                    <div class="avatar ${isUserMessage ? 'user' : 'bot'}">
                        <c:choose>
                            <c:when test="${isUserMessage}"><i class="bi bi-person-fill"></i></c:when> <%-- Icono de persona para usuario --%>
                            <c:otherwise><i class="bi bi-robot"></i></c:otherwise> <%-- Icono de robot para bot --%>
                        </c:choose>
                    </div>
